...
Route::get('/dashboard/sponsored', [DefaultController::class, 'sponsored'])->name('sponsored');
Route::get('/dashboard/support/{child}', [DefaultController::class, 'support'])->name('child.support');
